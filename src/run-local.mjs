...
process.env.GCP_SECRET_ID = 'arn:aws:secretsmanager:us-east-1:416823110122:secret:GCP_Solarman_Alexa_Invoker_Key-FtpVoD'; // Or just the secret name if using default region
process.env.TARGET_AUDIENCE = 'https://us-central1-solarman-smartthings.cloudfunctions.net/AlexaHandler';
