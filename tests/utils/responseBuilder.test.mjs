    ...
    const simpleResponseTestCases = [
      ...
      [
        ...
        {},
        {
          ...
          sessionAttributes: {},
          response: {
            outputSpeech: { type: 'PlainText', text: 'What next?' },
      ...
      [
        ...
        'Ask me something.',
        false,
        "I didn't hear that, what can I do?",
        {},
        {
          version: '1.0',
          sessionAttributes: {},
          response: {
            ...
            reprompt: {
              outputSpeech: {
                type: 'PlainText',
                text: "I didn't hear that, what can I do?",
              },
            },
          },
        },
      ...
      [
        ...
        {},
        {
          ...
          sessionAttributes: {},
          response: {
            outputSpeech: { type: 'PlainText', text: 'Okay, done.' },
            shouldEndSession: true,
          },
          // No reprompt object expected
        },
      ...
      [
        ...
        {
          version: '1.0',
          sessionAttributes: { key1: 'value1', count: 5 },
          response: {
            outputSpeech: { type: 'PlainText', text: 'Attributes set.' },
            shouldEndSession: true,
          },
        },
      ],
      [
        ...
        {
          version: '1.0',
          sessionAttributes: { state: 'asking' },
          response: {
  ...
  describe('buildAskResponse', () => {
    ...
    const askResponseTestCases = [
        ...
        {},
        {
          ...
          response: {
            ...
            reprompt: {
              outputSpeech: {
                type: 'PlainText',
                text: 'Please tell me your favorite color.',
              },
            },
          },
        },
      ...
      [
        ...
        'What else?',
        'Tell me more.',
        { lastIntent: 'SomeIntent' },
        {
          version: '1.0',
          sessionAttributes: { lastIntent: 'SomeIntent' },
          response: {
            outputSpeech: { type: 'PlainText', text: 'What else?' },
            shouldEndSession: false,
            reprompt: {
    ...
    it.each(askResponseTestCases)(
      ...
      (description, speech, reprompt, attributes, expected) => {
        expect(buildAskResponse(speech, reprompt, attributes)).toEqual(
          expected
        );
      }
    );
  ...
  describe('buildTellResponse', () => {
    ...
    const tellResponseTestCases = [
      [
        ...
        {},
        {
          ...
          response: {
            outputSpeech: {
              type: 'PlainText',
              text: 'Okay, closing the skill now.',
            },
            shouldEndSession: true,
          },
        },
      ...
      [
        ...
        {
          version: '1.0',
          sessionAttributes: { finalState: 'complete' },
          response: {
            outputSpeech: { type: 'PlainText', text: 'Final message.' },
            shouldEndSession: true,
          },
        },
      ],
