...
describe('GetCurrentPowerIntent Handler', () => {
    ...
    it('should return generic error message if GCP client throws generic error', async () => {
        ...
        expect(mockLogger.error).toHaveBeenCalledWith({ err: genericError }, 'Error calling GCP function for GetCurrentPowerIntent.');
        expect(result).toEqual(expectedResponse);
    });
    ...
    it('should return specific error message if GCP client throws error with statusCode 500', async () => {
        ...
        // Assert
        expect(mockGcpClient).toHaveBeenCalledTimes(1);
        expect(mockLogger.error).toHaveBeenCalledWith({ err: serverError }, 'Error calling GCP function for GetCurrentPowerIntent.');
        expect(result).toEqual(expectedResponse);
    });
    ...
    it('should return specific error message if GCP client throws error with statusCode 503', async () => {
        ...
        // Assert
        expect(mockGcpClient).toHaveBeenCalledTimes(1);
        expect(mockLogger.error).toHaveBeenCalledWith({ err: unavailableError }, 'Error calling GCP function for GetCurrentPowerIntent.');
        expect(result).toEqual(expectedResponse);
    });
    ...
    it('should return specific error message if GCP client throws timeout error', async () => {
        ...
        // Assert
        expect(mockGcpClient).toHaveBeenCalledTimes(1);
        expect(mockLogger.error).toHaveBeenCalledWith({ err: timeoutError }, 'Error calling GCP function for GetCurrentPowerIntent.');
        expect(result).toEqual(expectedResponse);
    });
